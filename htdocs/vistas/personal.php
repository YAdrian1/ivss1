...
<style>
   ...
   .codigo {
    ...
    .centro {
        ...
        width: 5px; /* Ajusta el ancho para el centro */
        ...
        <div  style="border:none; text-align: center;" class="row">
            <div class="col">
                <table   id="myTable" class="table table-striped" style="width:100%;">
                   <thead><tr style="background-color: #c4c2c2;   border:1px solid black;" class="tableizer-firstrow" ><th style="text-align: center; color: black;  border:1px solid black; " class="codigo">CÓDIGOS SERVICIOS</th><th style="text-align: center; color: black;  border:1px solid black;" class="cedula" >CEDULA</th><th style="text-align: center; color: black;  border:1px solid black;" class="apellido">APELLIDO</th><th style="color: black;  border:1px solid black; text-align: center;" class="nombre">NOMBRE</th><th style="text-align: center; color: black; color: black; border:1px solid black;" class="cargo">CARGO</th><th style="text-align: center; color: black;  border:1px solid black;" class="centro"> CENTRO</th></tr></thead>
